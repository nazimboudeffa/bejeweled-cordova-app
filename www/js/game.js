...
var fieldSize = window.innerWidth / orbSize;
//
var swapSpeed = 200;
var fallSpeed = 1000;
...
function drawField(){
     ...
     for(var i = 0; i < fieldSize; i ++){
          ...
          for(var j = 0; j < fieldSize; j ++){
               var orb = game.add.sprite(orbSize * j + orbSize / 2, orbSize * i + orbSize / 2, "snowflakes_large");
               orb.anchor.set(0.5);
               orbGroup.add(orb);
               do{
     ...
     for(var j = 0; j < fieldSize; j++){
          ...
          if(emptySpots > 0){
               ...
               for(i = 0; i < emptySpots; i++){
                    var orb = game.add.sprite(orbSize * j + orbSize / 2, - (orbSize * (emptySpots - 1 - i) + orbSize / 2), "snowflakes_large");
                    orb.anchor.set(0.5);
                    orbGroup.add(orb);
                    var randomColor = game.rnd.between(0, orbColors - 1);
                    orb.frame = randomColor;
